...
Now that we've gone over how LISP operates and a couple of LISP control-plane message formats. Let's discuss the format of LISP data-plane and control-plane packets.
