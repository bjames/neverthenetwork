...
Grep is used to find strings matching a pattern within a file. Grep has tons of options and can be used for finding just about anything you'd need to find so I *highly* recommend reading `man grep` as the need arises. 
