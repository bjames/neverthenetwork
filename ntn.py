...
def dns_check():
    ...
    return render_template('dns.html', dns_results = ntn_dns('neverthenetwork.com', 'A'), dns_active=True)
...
def curl():
    ...
    return render_template('curl.html', results = ntn_curl('neverthenetwork.com'), curl_active=True)
...
def subnet():
    ...
    return render_template('subnet.html', results = ntn_subnet('192.168.0.0', '/24'), subnet_active=True)